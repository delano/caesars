...
== Usage
     ...
     # In this example, the top level method is "staff" and we pass it an 
     # name so the instance variable will be called @staff_fte. Had we used 
     # "team :sad", it would have been called @team_sad.
     staff :fte do
